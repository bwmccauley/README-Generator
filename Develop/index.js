...
const questions = [
    ...
    },
    {
        type: 'input',
        name:'usage',
        message: 'What is the tuse of your project?',
        validate: usageInput => {
            if (usageInput) {
                return true;
            } else {
                console.log('Please proveide a use for your project');
                return false;
            }
        }
    },
    ...
    },
    {
        type: 'input',
        name: 'email',
        message: 'What is your email so there is another wat to be reached for questions?',
        validate: emailInput => {
            if (emailInput) {
                return true;
            } else {
...
const writeToFile = fileContent => {
    return new Promise((resolve, reject) => {
        ƒs.writeToFile('./generateREADME.md', fileContent, err => {
            if (err) {
                reject(err);
                return;
            }
